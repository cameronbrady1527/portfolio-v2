...
import { Grapher, SequenceBuilder, SymmetryExplorer, AngleExplorer, TriangleLab, slider, choose } from "@cameronbrady/math-components";
...
describe("public API — main entry", () => {
  ...
  it("exposes the AngleExplorer component", () => {
    expect(typeof AngleExplorer).toBe("function");
  });
