  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[350px] max-w-full shrink-0 rounded-xl border border-slate-200 bg-white/95 backdrop-blur-sm px-8 py-6 md:w-[450px] shadow-lg hover:shadow-xl transition-shadow duration-300"
            key={item.name}
          >
            <blockquote>
